...
stargazer(model0, model1, model2, column.labels = c("model 0", "model 1", "model 2"), header=FALSE, type='latex')
```
...
stargazer(model3,model4,column.labels = c("model 3","model 4"), header=FALSE, type='latex')
```
...
test_knn_log %>% head() %>% kable() %>% kable_styling()
```
